<template>
    <div class="consent-component" v-if="showConsent">
      ...
      <div>
        ...
        <AnalystFiltersList @open-tickets-filter="handleFilterOpened" @average-running-time-filter="handleFilterAverageTime" @exceeded-sla-filter="handleFilterExcedeedSLA" @by-month="handleFilterByMonth" @recurring-tickets="handleFilterRecurringTickets" @sentiment-volume="handleFilterSentimentVolume"/>
...
import AnalystFiltersList from '@/components/AnalystFiltersList.vue';
